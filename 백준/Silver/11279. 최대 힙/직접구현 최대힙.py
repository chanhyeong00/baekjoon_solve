...
class max_heap:
    ...
    def max_heap_up(self, k): # 인덱스 1이 루트 노트
    ...
    def max_heap_down(self, k): # 자식 노드중 더 큰 값과 교환
        ...
        while k < l:
            ...
            if left_child >= l: # 자식 아예 없는 경우
                ...
                if right_child >= l: # 왼쪽 자식만 있으면 비교후 왼쪽으로 내림
                    ...
                    if self.arr[left_child] > self.arr[right_child]: # 왼쪽 자식이 크면
    ...
    def insert(self, element):
        ...
        self.max_heap_up(len(self.arr)-1)
